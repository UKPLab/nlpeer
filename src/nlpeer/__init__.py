...
DATASET_PAPERFORMATS = {
    ...
    DATASETS.ARR_EMNLP_24: [PAPERFORMATS.PDF, PAPERFORMATS.ITG, PAPERFORMATS.GROBID],
    ...
    DATASETS.ELIFE: [PAPERFORMATS.PDF, PAPERFORMATS.ITG],
...
DATASET_REVIEW_OVERALL_SCALES = {
    ...
    DATASETS.ARR_EMNLP_24: (arr_overall_to_score, np.arange(1, 5 + 0.5, 0.5)),
